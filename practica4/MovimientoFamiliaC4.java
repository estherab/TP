...
public abstract class MovimientoFamiliaC4 extends Movimiento {
	 ...
	 * 
	 * @param tab : tablero
	 * @return fila : ú½ltima fila ocupada de la columna dada
	 */
	public int ultimaOcupada(Tablero tab) {
		...
		// Si devuelve un -1 quiere decir que toda la columna estaba llena y no se puede insertar ninguna ficha
		if (!encontrado)
			fila = -1;
