...
import tp.pr4.juegos.*;
import tp.pr4.logica.Partida;
import tp.pr4.vistas.Swing.VistaSwing;
import tp.pr4.vistas.consola.VistaConsola;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		int filas = ReglasConecta4.FILAS_C4, columnas = ReglasConecta4.COLUMNAS_C4;
			...
			if (argsNoEntendidos.length == 0) {
				...
				if (cmdLine.hasOption("h")) {
					...
					if (juego.equalsIgnoreCase("c4")) {
						...
						filas = ReglasConecta4.FILAS_C4;
						columnas = ReglasConecta4.COLUMNAS_C4;
					}

					else if (juego.equalsIgnoreCase("co")) {
						factoria = new FactoriaJuegoComplica();
						partida = new Partida(factoria.creaReglas());
						filas = ReglasComplica.FILAS_CO;
						columnas = ReglasComplica.COLUMNAS_CO;
					}
						...
						// Dimensiones por defecto 10 x 10
							...
							partida = new Partida(factoria.creaReglas());
							filas = FactoriaJuegoGravity.FILAS_GR;
							columnas = FactoriaJuegoGravity.COLUMNAS_GR;
						}
				...
				if (cmdLine.hasOption("u")) {
					...
					// Si se elige ventana
						...
						final VistaSwing vistaGrafica = new VistaSwing(controlGrafica, filas, columnas);
